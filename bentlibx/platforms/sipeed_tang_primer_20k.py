...
_dock_io = [
    # Leds
    ("led", 0,  Pins( "CARD1:44"), IOStandard("LVCMOS33")), # CHECKME: Should be LVCMOS33.
    ("led", 1,  Pins( "CARD1:46"), IOStandard("LVCMOS33")), # CHECKME: Should be LVCMOS33.
    ("led", 3,  Pins( "CARD1:40"), IOStandard("LVCMOS33")), # CHECKME: Should be LVCMOS33.
    ("led", 2,  Pins( "CARD1:42"), IOStandard("LVCMOS33")), # CHECKME: Should be LVCMOS33.
    ...
    # PMOD0
    ("pmod", 0, Pins("CARD1:27 CARD1:29 CARD1:33 CARD1:35 CARD1:39 P8 CARD1:47 CARD1:45"), IOStandard("LVCMOS33")),
#    ("pmod0", 0, Pins("CARD1:27"), IOStandard("LVCMOS33")),
#    ("pmod0", 1, Pins("CARD1:29"), IOStandard("LVCMOS33")),
#    ("pmod0", 2, Pins("CARD1:33"), IOStandard("LVCMOS33")),
#    ("pmod0", 3, Pins("CARD1:35"), IOStandard("LVCMOS33")),
#    ("pmod0", 4, Pins("CARD1:39"), IOStandard("LVCMOS33")),
#    ("pmod0", 5, Pins("P8"), IOStandard("LVCMOS33")),
#    ("pmod0", 6, Pins("CARD1:47"), IOStandard("LVCMOS33")),
#    ("pmod0", 7, Pins("CARD1:45"), IOStandard("LVCMOS33")),
    # PMOD1
#    ("pmod", 1, Pins("CARD1:53 CARD1:51 CARD1:59 CARD1:57 CARD1:75 CARD1:73 CARD1:85 CARD1:83"), IOStandard("LVCMOD33")),
    # ("pmod1", 0, 
    #     Subsignal("p", Pins("CARD1:53 CARD1:59 CARD1:75 CARD1:85"), IOStandard("LVCMOS33D")),
    #     Subsignal("n", Pins("CARD1:51 CARD1:57 CARD1:73 CARD1:83"), IOStandard("LVCMOS33D")),
    # ),
    ("pmod1d", 0, 
        Subsignal("p", Pins("CARD1:53")),
        Subsignal("n", Pins("CARD1:51")),
#        IOStandard("LVDS25")
    ),
    ("pmod1d", 1, 
        Subsignal("p", Pins("CARD1:59")),
        Subsignal("n", Pins("CARD1:57")),
#        IOStandard("LVDS25")
    ),
    ("pmod1d", 2, 
        Subsignal("p", Pins("CARD1:75")),
        Subsignal("n", Pins("CARD1:73")),
#        IOStandard("LVDS25")
    ),
    ("pmod1d", 3, 
        Subsignal("p", Pins("CARD1:85")),
        Subsignal("n", Pins("CARD1:83")),
#        IOStandard("LVDS25")
    ),
    ("pmod", 1, Pins("CARD1:53          CARD1:59          CARD1:75          CARD1:85         "), IOStandard("LVCMOS33D"), Drive("24")),
